...
const Challenge = () => {
  ...
  return <section className="py-32 bg-clinical-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,hsl(var(--luxury-sand))_0%,transparent_50%)]"></div>
      
      <div className="container mx-auto px-6 relative z-10 bg-slate-50 text-gray-700">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {challenges.map((item, index) => <div key={index} className="group p-8 rounded-2xl bg-background/50 backdrop-blur-sm border border-border hover:border-luxury-bronze/30 shadow-card transition-smooth hover:shadow-luxury">
